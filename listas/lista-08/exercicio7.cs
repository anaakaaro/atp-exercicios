...
//informada a menor nota entre os alunos aprovados.
...
class Program
{
    static void Main()
    {
        ...
        double menorNotaAprovados = 101;

        foreach(double nota in notas)
        {
            if(nota >= 60){
                alunosAprovados++;
                if(nota < menorNotaAprovados) menorNotaAprovados = nota;
            }
        }
        ...
        Console.WriteLine($"Menor nota entre os alunos aprovados: {menorNotaAprovados}");
